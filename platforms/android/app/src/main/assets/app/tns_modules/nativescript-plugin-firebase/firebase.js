            ...
            var onCompleteListener = new com.google.android.gms.tasks.OnCompleteListener({
                onComplete: function (task) {
                    if (!task.isSuccessful()) {
                        ...
                        resolve(new firebase_common_1.DocumentSnapshot(result_3 ? result_3.getId() : null, !!result_3, function () { return result_3 ? firebase_common_1.firebase.toJsObject(result_3.getData()) : null; }));
                    }
                }
            });
            var onFailureListener = new com.google.android.gms.tasks.OnFailureListener({
